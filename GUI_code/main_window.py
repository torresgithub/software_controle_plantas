...
################################################################################
## Form generated from reading UI file 'main_windowLtwBIT.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_test_type = QGroupBox(self.tab_general_configuration)
        self.groupBox_test_type.setObjectName(u"groupBox_test_type")
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.groupBox_test_type.sizePolicy().hasHeightForWidth())
        self.groupBox_test_type.setSizePolicy(sizePolicy)
        self.groupBox_test_type.setMinimumSize(QSize(0, 0))
        self.verticalLayoutWidget = QWidget(self.groupBox_test_type)
        self.verticalLayoutWidget.setObjectName(u"verticalLayoutWidget")
        self.verticalLayoutWidget.setGeometry(QRect(10, 20, 131, 71))
        self.verticalLayout_7 = QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout_7.setObjectName(u"verticalLayout_7")
        self.verticalLayout_7.setContentsMargins(0, 0, 0, 0)
        self.radioButton_open_loop = QRadioButton(self.verticalLayoutWidget)
        self.radioButton_open_loop.setObjectName(u"radioButton_open_loop")
        self.radioButton_open_loop.setChecked(True)

        self.verticalLayout_7.addWidget(self.radioButton_open_loop)

        self.radioButton_closed_loop = QRadioButton(self.verticalLayoutWidget)
        self.radioButton_closed_loop.setObjectName(u"radioButton_closed_loop")

        self.verticalLayout_7.addWidget(self.radioButton_closed_loop)


        self.horizontalLayout_6.addWidget(self.groupBox_test_type)
        ...
        if (self.tableWidget_prog_input.rowCount() < 20):
            self.tableWidget_prog_input.setRowCount(20)
        ...
        self.tabWidget.addTab(self.tab_general_configuration, "")
        ...
        self.tabWidget.addTab(self.tab_comm_serial, "")
        ...
        self.tabWidget_2 = QTabWidget(self.tab_controller)
        ...
        sizePolicy1.setHeightForWidth(self.tab_general_config.sizePolicy().hasHeightForWidth())
        self.tab_general_config.setSizePolicy(sizePolicy1)
        self.verticalLayout_16 = QVBoxLayout(self.tab_general_config)
        self.verticalLayout_16.setObjectName(u"verticalLayout_16")
        self.groupBox_2 = QGroupBox(self.tab_general_config)
        ...
        self.textEdit_control_info = QTextEdit(self.groupBox_2)
        ...
        self.groupBox = QGroupBox(self.tab_general_config)
        ...
        self.checkBox.setGeometry(QRect(10, 20, 231, 41))
        font = QFont()
        ...
        self.widget.setGeometry(QRect(51, 80, 114, 48))
        ...
        self.spinBox_Cp = QSpinBox(self.widget)
        ...
        self.spinBox_Cn = QSpinBox(self.widget)
        ...
        self.plainTextEdit_ctrl_code.setFont(font1)
...
"}")
        ...
        self.tabWidget_2.addTab(self.tab_generic_controller, "")
...
"border-color: rgb(85, 0, 255);")
        ...
        self.lineEdit_manual_input.setGeometry(QRect(90, 60, 41, 21))
        ...
        self.label_manual_input.setGeometry(QRect(40, 60, 51, 21))
        ...
        sizePolicy1.setHeightForWidth(self.groupBox_SaveData.sizePolicy().hasHeightForWidth())
        self.groupBox_SaveData.setSizePolicy(sizePolicy1)
...
"(envia para a Plataforma).", None))
        self.groupBox_test_type.setTitle(QCoreApplication.translate("MainWindow", u"Tipo de Ensaio", None))
        self.radioButton_open_loop.setText(QCoreApplication.translate("MainWindow", u"Malha Aberta", None))
        self.radioButton_closed_loop.setText(QCoreApplication.translate("MainWindow", u"Malha Fechada", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_general_configuration), QCoreApplication.translate("MainWindow", u"Vis\u00e3o Geral do Ensaio", None))
#if QT_CONFIG(tooltip)
...
"com o Sistema", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_comm_serial), QCoreApplication.translate("MainWindow", u"Comunica\u00e7\u00e3o Serial", None))
        self.groupBox_2.setTitle(QCoreApplication.translate("MainWindow", u"Escolha do Controlador", None))
        self.radioButton.setText(QCoreApplication.translate("MainWindow", u"PID em \"s\"", None))
        self.radioButton_2.setText(QCoreApplication.translate("MainWindow", u"FT em \"s\"", None))
        self.radioButton_3.setText(QCoreApplication.translate("MainWindow", u"PID discreto", None))
        self.radioButton_5.setText(QCoreApplication.translate("MainWindow", u"FT discreta", None))
        self.radioButton_4.setText(QCoreApplication.translate("MainWindow", u"Gen\u00e9rico", None))
...
#endif // QT_CONFIG(tooltip)
        self.groupBox.setTitle(QCoreApplication.translate("MainWindow", u"Compensa\u00e7\u00e3o de Zona Morta", None))
        self.checkBox.setText(QCoreApplication.translate("MainWindow", u"Usar compensa\u00e7\u00e3o de Zona Morta", None))
        ...
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_general_config), QCoreApplication.translate("MainWindow", u"Configura\u00e7\u00f5es Gerais", None))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_PID_controller), QCoreApplication.translate("MainWindow", u"PID em \"s\"", None))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_FT_controller), QCoreApplication.translate("MainWindow", u"FT em \"s\"", None))
...
"Enviar para o ESP32", None))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_generic_controller), QCoreApplication.translate("MainWindow", u"Gen\u00e9rico", None))
#if QT_CONFIG(tooltip)
        self.tabWidget_2.setTabToolTip(self.tabWidget_2.indexOf(self.tab_generic_controller), QCoreApplication.translate("MainWindow", u"Entre o c\u00f3digo de um controlador gen\u00e9rico.", None))
#endif // QT_CONFIG(tooltip)
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_controller), QCoreApplication.translate("MainWindow", u"Controlador", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_experiment), QCoreApplication.translate("MainWindow", u"Experimento", None))
    # retranslateUi
